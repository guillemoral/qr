//
//  CameraResponseMapperData.swift
//  QR
//
...
class CameraAuthorizationMapperData: MapperBase<AuthorizationEntity, AVAuthorizationStatus> {
    ...
    override func mapToEntity(model: AVAuthorizationStatus) -> AuthorizationEntity {
        ...
        switch model {
            ...
            case .denied:
                return AuthorizationEntity(status: .denied)
            case .authorized:
